          ...
          <h3 className={`${mulish.className} text-3xl text-white text-center py-6`}>What We Do Best</h3>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col md:flex-row md:h-[350px] gap-4">
                ...
                <div className="flex flex-col gap-2 md:h-full md:w-[65%] bg-[#F5F5F5] p-4 md:relative rounded-xl shadow-custom">
                ...
                <div className="flex flex-col gap-2 md:h-full md:w-[35%] bg-[#CED754] p-4 md:relative rounded-xl shadow-custom">
              ...
              <div className="flex flex-col md:flex-row md:h-[350px] gap-4">
                ...
                <div className="flex flex-col gap-2 md:h-full md:w-[50%] bg-[#066FE0] p-4 md:relative rounded-xl shadow-custom border border-amber-50">
                ...
                <div className="bg-[#F5F5F5] flex flex-col gap-2 md:h-full md:w-[50%] p-4 md:relative rounded-xl shadow-custom">
